...
<head>
    ...
    <!-- Titre de la Page -->
    <title>All Might - Mentions Légales</title>
...
<body>
    ...
    <!-- BANNER MENTIONS LEGALES -->
    <section class="bannerPageML"></section>
    ...
    <section class="mention">
        ...
        <div class="tete">
            ...
            <br>
            <p>Site Web créé dans le cadre d'un projet scolaire.<br>Thème du projet: Faire un site web sur un personnage fictif.<br>Choix: Toshinori "All Might" Yagi<br><br></p>
            <p> Axel CARANDANG, soucieux des droits des individus, notamment au regard des traitements automatisés, et dans une volonté de transparence avec ses clients, a mis en place une politique reprenant l’ensemble de ces traitements, des finalités poursuivies par ces derniers ainsi que des moyens d’actions à la disposition des individus afin qu’ils puissent au mieux exercer leurs droits.
        ...
        <div class="corp">
            ...
            <div class="partie1">
                ...
                <h3>Article 1 - Mentions légale</h3><br>

                <p>
                    1.1 Site (ci-après « le site ») : All Might<br><br>
            ...
            <div class="partie3">
                ...
                <h3>Article 3 - Contenu du site</h3><br>

                <p>
                    Toutes les marques, photographies, textes, commentaires, illustrations, images animées ou non, séquences vidéo, sons, ainsi que toutes les applications informatiques qui pourraient être utilisées pour faire fonctionner ce site et plus généralement tous les éléments reproduits ou utilisés sur le site sont protégés par les lois en vigueur au titre de la propriété intellectuelle.
                    Ils sont la propriété pleine et entière de l'éditeur ou de ses partenaires ou sont libres de droits. Toute reproduction, représentation, utilisation ou adaptation, sous quelque forme que ce soit, de tout ou partie de ces éléments, y compris les applications informatiques, sans l'accord préalable et écrit de l'éditeur, sont strictement interdites. Le fait pour l'éditeur de ne pas engager de procédure dès la prise de connaissance de ces utilisations non autorisées ne vaut pas acceptation desdites utilisations et renonciation aux poursuites. </p><br>

            </div>

            <div class="partie4">

                <h3>Article 4 - Gestion du site</h3><br>
            ...
            <div class="partie5">
                ...
                <h3>Article 5 - Responsabilités</h3><br>
            ...
            <div class="partie7">
                ...
                <h3>Article 7 - Collecte et protection des données</h3><br>

                <p>
                    Vos données sont collectées par X.<br>
            ...
            <div class="partie8">
                ...
                <h3>Article 8 - Droit d’accès, de rectification et de déréférencement de vos données</h3><br>
                ...
                <p>
                    ...
                    • Le droit à la portabilité : ils peuvent réclamer que la Plateforme leur remet les données personnelles qui lui ont fourni pour les transmettre à une nouvelle Plateforme.<br><br>
                    Vous pouvez exercer ce droit en nous contactant, à l’adresse suivante :<br>
                    X, 75116 Paris<br><br>
                    Ou par email, à l’adresse :<br>axel.carandang2@edu.devinci.fr<br><br>
                    ...
                    De plus, et depuis la loi n°2016-1321 du 7 octobre 2016, les personnes qui le souhaitent, ont la possibilité d’organiser le sort de leurs données après leur décès. Pour plus d’information sur le sujet, vous pouvez consulter le site Internet de la CNIL : https://www.cnil.fr/.<br><br>
                    Les utilisateurs peuvent aussi introduire une réclamation auprès de la CNIL sur le site de la CNIL : https://www.cnil.fr. <br><br>
            ...
            <div class="partie9">
                ...
                <h3>Article 9 - Utilisation des données</h3><br>
            ...
            <div class="partie10">
                ...
                <h3>Article 10 - Politique de conservation des données</h3><br>

                <p>
                    La Plateforme conserve vos données pour la durée nécessaire pour vous fournir ses services ou de vous fournir une assistance.<br>
            ...
            <div class="partie11">
                ...
                <h3>Article 11- Partage des données personnelles avec des tiers</h3><br>

                <p>
                    Les données personnelles peuvent être partagées avec des sociétés tierces exclusivement dans l’Union européenne, dans les cas suivants :<br><br>
            ...
            <div class="partie12">
                ...
                <h3>Article 12 - Offres commerciales</h3><br>

                <p>
                    Vous êtes susceptible de recevoir des offres commerciales de l'éditeur. Si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : azor40k@gmail.com<br>
                    Vos données sont susceptibles d’être utilisées par les partenaires de l'éditeur à des fins de prospection commerciale, Si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : azor40k@gmail.com<br>
            ...
            <div class="partie13">
                ...
                <p>
                    ...
                    Les cookies suivants sont présents sur ce site :<br><br><br>
                    La durée de vie de ces cookies est de treize mois.<br><br>P
                    our plus d’informations sur l’utilisation, la gestion et la suppression des « cookies », pour tout type de navigateur, nous vous invitons à consulter le lien suivant : https://www.cnil.fr/fr/cookies-les-outils-pour-les-maitriser.
            ...
            <div class="partie14">
                ...
                <h3>Article 14 - Photographies et représentation des produits</h3><br>
            ...
            <div class="partie15">
                ...
                <h3>Article 15 - Loi applicable</h3><br>
            ...
            <div class="partie16">
                ...
                <h3>Article 16 - Contactez-nous</h3><br>

                <p>
                    Pour toute question, information sur les produits présentés sur le site, ou concernant le site lui-même, vous pouvez laisser un message à l'adresse suivante : axel.carandang2@edu.devinci.fr .
                </p><br><br><br><br>
